...
@Configuration
@Import({CfgSpaceValidator.class, CfgSecretTest.class,})
public class CfgSpaceValidatorTest {
    ...
    public JwtTokenProvider jwtTokenProvider(@Autowired JwtTokenProvider realJwtTokenProvider) {
        ...
        when(mockedJwtTokenProvider
                .createToken(any(), anyString(), anyString(), any(), anyString(), anyString()))
